...
# -*- coding: utf-8 -*-
#
# frft documentation build configuration file, created by
...
latex_documents = [
  ('index', 'frft.tex', 'frft Documentation',
...
texinfo_documents = [
  ('index', 'frft', 'frft Documentation',
   'International AudioLabs Erlangen', 'frft', 'One line description of project.',
   'Miscellaneous'),
]
